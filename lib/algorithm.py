...
# ============================================================
# 2026-07-21 E 靶点重构: 以下 fetcher 实现已迁移到 lib.market_data.py
# (本文件只保留纯算法: slope/sharpe/adx/classify/...)
# 旧 import 路径 from lib.algorithm import tencent_market_prefix 等
# 由 lib.market_data 的 re-export 兼容 (顶部已经 import)
# ============================================================
